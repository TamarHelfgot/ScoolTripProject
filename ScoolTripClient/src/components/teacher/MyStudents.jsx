        ...
        <div style={{ minHeight: '100vh', fontFamily: "'Heebo', sans-serif" }}>
            ...
            <div style={{ position: 'relative', zIndex: 2, padding: '2rem 1.5rem', maxWidth: 900, margin: '0 auto' }}>
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <h2 style={{ color: '#fff', fontWeight: 900, margin: 0 }}>תלמידות הכיתה שלי</h2>
                </div>
                ...
                {!loading && (
                    <div style={{
                        ...
                        <h5 className="text-end mb-3" style={{ color: '#f0dfa0', fontWeight: 700 }}>
                        ...
                        {students.length === 0 && (
                            <p style={{ color: 'rgba(255,255,255,0.35)', textAlign: 'center', marginTop: '1rem' }}>
                                אין תלמידות בכיתה
                            </p>
                        )}
                    </div>
